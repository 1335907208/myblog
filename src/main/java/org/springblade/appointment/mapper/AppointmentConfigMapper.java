...
public interface AppointmentConfigMapper extends BaseMapper<AppointmentConfig> {
	 ...
	 * @return
	 */
	List<AppointmentConfigVO> selectAppointmentConfigPage(IPage page, AppointmentConfigVO appointmentConfig);
	 ...
	 * @return
	 */
	List<AppointmentConfig> selectConfigWithProject(@Param("ew")QueryWrapper wrapper);
