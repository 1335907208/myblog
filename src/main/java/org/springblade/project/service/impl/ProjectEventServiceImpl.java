...
import org.springblade.project.mapper.ProjectEventMapper;
...
public class ProjectEventServiceImpl extends BaseServiceImpl<ProjectEventMapper, ProjectEvent> implements IProjectEventService {
	...
	@Override
	public IPage<ProjectEventVO> selectProjectEventPage(IPage<ProjectEventVO> page, ProjectEventVO projectEvent) {
		return page.setRecords(baseMapper.selectProjectEventPage(page, projectEvent));
	}
