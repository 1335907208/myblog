 ...
 * @since 2020-06-30
 */
public interface ProjectGalleryMapper extends BaseMapper<ProjectGallery> {
	 ...
	 * @return
	 */
	List<ProjectGalleryVO> selectProjectGalleryPage(IPage page, ProjectGalleryVO projectGallery);
